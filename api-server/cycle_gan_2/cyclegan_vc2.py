...
from cycle_gan_2.modules import PatchGanDiscriminator, Generator212
from cycle_gan_2.utils import l1_loss, l2_loss
...
class CycleGAN2(object):
    ...
    def __init__(self, num_features, batch_size=1, discriminator=PatchGanDiscriminator, generator=Generator212,
                 mode='train', log_dir='./log', sess_config=None):
